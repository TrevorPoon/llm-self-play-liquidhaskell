...
#SBATCH --gres=gpu:a40:4                  # one A40 GPU is sufficient for inference
#SBATCH --mem=192000
...
export ADAPTER_PATH="output/deepseek-ai/DeepSeek-R1-Distill-Qwen-1.5B_dataset_fraction_0.05_epochs_3_learning_rate_1e-5_batch_4_grad_steps_8/final_adapter"
