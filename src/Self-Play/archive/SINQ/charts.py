...
def generate_difficulty_chart(base_path, output_folder):
    ...
    while True:
        ...
        candidate_examples_path = os.path.join(iteration_path, "candidate_examples.jsonl")
...
base_output_dir = "output/deepseek-ai/DeepSeek-R1-Distill-Qwen-1.5B_SINQ_PROGRAMS200_EVALS0_no_initial_adapter_LR5e-4_EPOCHS3"
