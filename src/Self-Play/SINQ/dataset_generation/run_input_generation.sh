...
#SBATCH --gres=gpu:a40:2                 # specifically one A40 GPU
#SBATCH --mem=256000
...
CUDA_VISIBLE_DEVICES=0,1 python -u generate_haskell_inputs.py \
    --model_name_or_path "RedHatAI/DeepSeek-R1-Distill-Llama-70B-FP8-dynamic" \
